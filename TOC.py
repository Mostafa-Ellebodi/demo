...
def upload_s3(fName):
    cmd1 = "'aws s3 cp ../output/{0} s3://streamlitdocx/{1}'".format(fName,fName)
    os.system(cmd1)
    cmd2 = "'aws s3api put-object-acl --bucket streamlitdocx --key {0} --acl public-read'".format(fName)
    os.system(cmd2)
...
if st.button("Get TOC"):
    ...
    #     docs_headlines.append(headlines)
        ...
        for fName in os.listdir(OUTPUT_PATH):
            upload_s3(fName)
            link = "https://streamlitdocx.s3.us-east-1.amazonaws.com/"+fName
