...
if st.button("Get TOC"):
    ...
    #     docs_headlines.append(headlines)
        ...
        if len(uploaded_files) ==1:
            ...
            ## print TOC
            TOC_List = ['1. The user interface and the work you do', '2. We are merging the digital and physical world', '3. Minority Report', '4. The 21st century is the smartest computer in your room']
